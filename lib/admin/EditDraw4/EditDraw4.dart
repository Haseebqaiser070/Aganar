...
class EditDraw4 extends StatefulWidget {
  EditDraw4({Key? key,required this.drawRef}) : super(key: key);
  DocumentReference drawRef;

  @override
  State<EditDraw4> createState() => _EditDraw4State();
}
class _EditDraw4State extends State<EditDraw4> {
  ...
  Future getDraw()async{
    ...
    limiteC.text = draw['limite'].toString();
    url = draw['image'];
    setState(() {
              ...
              InkWell(
                onTap: ()async{
                  ...
                  if(formK.currentState!.validate()){
                    editDraw2(nameC.text, int.parse(limiteC.text),url!);
                  }
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
  ...
  Future editDraw2(String name,int limite,String img)async{
