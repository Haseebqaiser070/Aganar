...
import '../AddSorteo3User/AddSorteo3User.dart';
import '../AddSorteo4User/AddSorteo4User.dart';


class AddUserSorteo4 extends StatefulWidget {
  AddUserSorteo4({Key? key,required this.Drawref}) : super(key: key);
  DocumentReference Drawref;

  @override
  State<AddUserSorteo4> createState() => _AddUserSorteo4State();
}

class _AddUserSorteo4State extends State<AddUserSorteo4> {
  @override
                            ...
                            child: FFButtonWidget(
                              onPressed:() async {
                                ...
                                if(!drawData['participants'].contains(e.reference)){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=> AddSorteo4User(sorteo: drawData,userRef: e.reference,)));
                                }
                                else{
