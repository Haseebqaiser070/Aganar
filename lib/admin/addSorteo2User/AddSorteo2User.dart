...
class AddSorteo2User extends StatefulWidget {
  AddSorteo2User({Key? key,required this.sorteo,required this.userRef}) : super(key: key);
  Map<String,dynamic> sorteo;
  DocumentReference userRef;
  @override
  State<AddSorteo2User> createState() => _AddSorteo2UserState();
}

class _AddSorteo2UserState extends State<AddSorteo2User> {
        ...
        children: [
          ...
          InkWell(
            onTap: ()async{
              ...
              sendNotification(widget.userRef, "You are added.", "${widget.sorteo['name']} will start on time.");
              triggerPushNotification(
                notificationTitle:
                'You are added.',
                notificationText:
                '${widget.sorteo['name']} will start on time.',
                notificationSound:
                'default',
