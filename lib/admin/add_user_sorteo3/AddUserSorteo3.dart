...
class AddUserSorteo3 extends StatefulWidget {
  AddUserSorteo3({Key? key,required this.Drawref}) : super(key: key);
  DocumentReference Drawref;

  @override
  State<AddUserSorteo3> createState() => _AddUserSorteo3State();
}

class _AddUserSorteo3State extends State<AddUserSorteo3> {
  @override
                            ...
                            child: FFButtonWidget(
                              onPressed:() async {
                                ...
                                if(!drawData['participants'].contains(e.reference)){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=> AddSorteo3User(sorteo: drawData,userRef: e.reference,)));
                                }
                                else{
