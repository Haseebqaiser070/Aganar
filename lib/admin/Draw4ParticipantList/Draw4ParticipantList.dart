...
class DrawParticipantList extends StatefulWidget {
  DrawParticipantList({Key? key,required this.drawRef}) : super(key: key);
  DocumentReference drawRef;
  @override
  State<DrawParticipantList> createState() => _DrawParticipantListState();
}

class _DrawParticipantListState extends State<DrawParticipantList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          SizedBox(height: 20,),
          Text("Toda la lista de participantes.",style: FlutterFlowTheme.of(context).titleSmall),
          SizedBox(height: 50,),
          Expanded(
            child: StreamBuilder(
