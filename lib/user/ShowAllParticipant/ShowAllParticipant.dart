...
import 'package:sorteoaganar/backend/push_notifications/push_notifications_util.dart';
...
class ShowAllParticipant extends StatefulWidget {
  ShowAllParticipant({Key? key,required this.drawRef}) : super(key: key);
  DocumentReference drawRef;
  @override
  State<ShowAllParticipant> createState() => _ShowAllParticipantState();
}

class _ShowAllParticipantState extends State<ShowAllParticipant> {
              ...
              if(winnerRef != null){
                ...
                if(winnerRef == currentUserReference){
                  ...
                  await sendNotification(
                      ...
                      "Eres ganadora",
                      "tu nivel es ahora.");
                  triggerPushNotification(notificationTitle: "Eres ganadora", notificationText: "tu nivel es ahora.", userRefs: [currentUserReference!], initialPageName: 'notifications', parameterData: {});
                  await currentUserReference!.update({
                    'level': currentUserLevel+1,
                  });
                }
                Navigator.push(context, MaterialPageRoute(builder: (context)=> Draw2Winner(userRef: winnerRef!,drawRef: widget.drawRef,)));
              }
            },
            child: Container(
