...
class PrivateDrawWinner extends StatefulWidget {
  PrivateDrawWinner({Key? key, required this.userRef, required this.drawRef})
      : super(key: key);
  DocumentReference userRef;
  DocumentReference drawRef;

  @override
  State<PrivateDrawWinner> createState() => _PrivateDrawWinnerState();
}

class _PrivateDrawWinnerState extends State<PrivateDrawWinner> {
