...
class ShowTicketList3 extends StatefulWidget {
  ShowTicketList3({Key? key,required this.sorteo}) : super(key: key);
  Map<String,dynamic> sorteo;
  @override
  State<ShowTicketList3> createState() => _ShowTicketList3State();
}

class _ShowTicketList3State extends State<ShowTicketList3> {
